...
$page_title = "Create Article - NR Intellitech";
    ...
    if (empty($errors)) {
        try {
            $query = "INSERT INTO news_articles 
                     (title, content, excerpt, category, date, author, status, is_featured, image_url, external_link) 
                     VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            
            $stmt = $db->prepare($query);
            $stmt->execute([
                $title, $content, $excerpt, $category, $date, $author, $status, 
                $is_featured, $image_url, $external_link
            ]);

            $article_id = $db->lastInsertId();
            header("Location: index.php?success=Article created successfully");
            exit;
    ...
    <div class="admin-container">
        <aside class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li><a href="/admin/news/create" class="active"><i class="fas fa-plus"></i> Create Article</a></li>
            </ul>
        </aside>
        ...
        <main class="main-content">
            ...
            <form method="POST" class="article-form">
                ...
                <div class="form-group">
                    ...
                    <textarea id="content" name="content" class="form-control" rows="10" required><?php echo htmlspecialchars($_POST['content'] ?? ''); ?></textarea>
                </div>

                <div class="form-group">
                    <label for="excerpt">Excerpt</label>
                    <textarea id="excerpt" name="excerpt" class="form-control" rows="3"><?php echo htmlspecialchars($_POST['excerpt'] ?? ''); ?></textarea>
                    <small>Brief summary of the article (optional)</small>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="author" name="author" class="form-control" 
                               value="<?php echo htmlspecialchars($_POST['author'] ?? 'Admin'); ?>">
                    </div>
